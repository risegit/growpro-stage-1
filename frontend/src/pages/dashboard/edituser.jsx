...
export default function EditUserForm() {
            ...
            try {
                ...
                if (data.status === "success" && data.data) {
                    ...
                    setFormData({
                        ...
                        aadhaarCard: user.aadhaar_card ? `${import.meta.env.VITE_API_URL}uploads/users/${user.aadhaar_card}` : null,
                    ...
                    // Set preview images
                    if (user.profile_pic) {
                        setPreviewImage(`${import.meta.env.VITE_API_URL}uploads/users/${user.profile_pic}`);
                    }
                    if (user.aadhaar_card) {
                        setAadhaarPreview(`${import.meta.env.VITE_API_URL}uploads/users/${user.aadhaar_card}`);
                    }
                } else {
    ...
    useEffect(() => {
        return () => {
            ...
            if (aadhaarPreview && aadhaarPreview.startsWith('blob:')) URL.revokeObjectURL(aadhaarPreview);
        };
